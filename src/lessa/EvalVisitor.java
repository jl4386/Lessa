...
public class EvalVisitor extends ExprBaseVisitor<String> {
	...
	// stmt -> simple_stmt
	@Override
	public String visitSIMPLESTMT(ExprParser.SIMPLESTMTContext ctx) {
	...
	// stmt -> expr_stmt
	@Override
	public String visitEXPRSTMT(ExprParser.EXPRSTMTContext ctx) {
	...
	// stmt -> compound_stmt
	@Override
	public String visitCOMPSTMT(ExprParser.COMPSTMTContext ctx) {
	...
	// stmt -> selection_stmt
	@Override
	public String visitSELECTSTMT(ExprParser.SELECTSTMTContext ctx) {
	...
	// stmt: iteration_stmt
	@Override
	public String visitITRSTMT(ExprParser.ITRSTMTContext ctx) {
	...
	// stmt: assign_stmt
	@Override
	public String visitASSIGNSTMT(ExprParser.ASSIGNSTMTContext ctx) {
	...
	// stmt: jump_stmt
	@Override
	public String visitJMPSTMT(ExprParser.JMPSTMTContext ctx) {
	...
	@Override
	public String visitSimple_stmt(ExprParser.Simple_stmtContext ctx) {
	...
	@Override
	public String visitSmall_stmt(ExprParser.Small_stmtContext ctx) {
	...
	@Override
	public String visitDel_stmt(ExprParser.Del_stmtContext ctx) {
	...
	@Override
	public String visitIMNAMESTMT(ExprParser.IMNAMESTMTContext ctx) {
	...
	@Override
	public String visitIMFROMSTMT(ExprParser.IMFROMSTMTContext ctx) {
	...
	@Override
	public String visitImport_from(ExprParser.Import_fromContext ctx) {
	...
	@Override
	public String visitImport_as_names(ExprParser.Import_as_namesContext ctx) {
		...
		println("import_as_names -> import_as_name (',' import_as_name)* return:"
				+ ret);
		return ret;
	}
	...
	@Override
	public String visitImport_as_name(ExprParser.Import_as_nameContext ctx) {
	...
	@Override
	public String visitImport_name(ExprParser.Import_nameContext ctx) {
		println("import_name -> IMPORT dotted_as_names");
		String ret = ctx.IMPORT().getText() + " "
				+ visit(ctx.dotted_as_names());
	...
	@Override
	public String visitDotted_as_names(ExprParser.Dotted_as_namesContext ctx) {
		...
		println("dotted_as_names -> dotted_as_name (',' dotted_as_name)* return:"
				+ ret);
		return ret;
	}
	...
	@Override
	public String visitDotted_as_name(ExprParser.Dotted_as_nameContext ctx) {
	...
	@Override
	public String visitDotted_name(ExprParser.Dotted_nameContext ctx) {
	...
	@Override
	public String visitBJMP(ExprParser.BJMPContext ctx) {
		return visit(ctx.break_stmt());
	}

	// jump_stmt: continue_stmt
	@Override
	public String visitCJMP(ExprParser.CJMPContext ctx) {
		return visit(ctx.continue_stmt());
	}

	// jump_stmt: return_stmt
	@Override
	public String visitRJMP(ExprParser.RJMPContext ctx) {
		return visit(ctx.return_stmt());
	}

	// break_stmt: BREAK ';'
	@Override
	public String visitBreak_stmt(ExprParser.Break_stmtContext ctx) {
		return ctx.BREAK().getText();
	}

	// continue_stmt: CONTINUE ';' ;
	@Override
	public String visitContinue_stmt(ExprParser.Continue_stmtContext ctx) {
		return ctx.CONTINUE().getText();
	}

	// return_stmt: RETURN (test_list)? ';'
	@Override
	public String visitReturn_stmt(ExprParser.Return_stmtContext ctx) {
	...
	@Override
	public String visitCompound_stmt(ExprParser.Compound_stmtContext ctx) {
	...
	@Override
	public String visitLISTLISTSTMT(ExprParser.LISTLISTSTMTContext ctx) {
	...
	// stmt_list: stmt
	@Override
	public String visitLISTSTMT(ExprParser.LISTSTMTContext ctx) {
	...
	@Override
	public String visitAssign_stmt(ExprParser.Assign_stmtContext ctx) {
		...
		if (leftExpr.substring(0, 1).equals("#")) {
			...
			retValue = visit(ctx.expr(0)) + " " + visit(ctx.assign_operators())
					+ " " + visit(ctx.expr(1));
		}
	...
	@Override
	public String visitASSIGNOP(ExprParser.ASSIGNOPContext ctx) {
		return ctx.ASSIGN().getText();
	}

	// assign_operators: PLUSASSIGN
	@Override
	public String visitPASSIGNOP(ExprParser.PASSIGNOPContext ctx) {
		return ctx.PLUSASSIGN().getText();
	}

	// assign_operators: MINUSASSIGN
	@Override
	public String visitMASSIGNOP(ExprParser.MASSIGNOPContext ctx) {
		return ctx.MINUSASSIGN().getText();
	}

	// assign_operators: TIMESASSIGN
	@Override
	public String visitTASSIGNOP(ExprParser.TASSIGNOPContext ctx) {
		return ctx.TIMESASSIGN().getText();
	}

	// assign_operators: DIVIDEASSIGN
	@Override
	public String visitDASSIGNOP(ExprParser.DASSIGNOPContext ctx) {
		return ctx.DIVIDEASSIGN().getText();
	}

	// selection_stmt -> IF '(' test ')' stmt (ELIF '(' test ')' stmt)* (ELSE
	// stmt)?
	@Override
	...
	@Override
	public String visitWILEITR(ExprParser.WILEITRContext ctx) {
	...
	@Override
	public String visitFORITR(ExprParser.FORITRContext ctx) {
	...
	public String visitFuncdef(ExprParser.FuncdefContext ctx) {
		...
		if (!classflag) {
			ImpStmt is = new ImpStmt("from "
					+ Envir.tempFileName.substring(0,
							Envir.tempFileName.length() - 3) + " import "
					+ name);
	...
	public String visitClassdef(ExprParser.ClassdefContext ctx) {
		...
		ImpStmt is = new ImpStmt("from "
				+ Envir.tempFileName.substring(0,
						Envir.tempFileName.length() - 3) + " import " + name);
		Envir.defTable.put(name, is);
	...
	@Override
	public String visitWhile_stmt(ExprParser.While_stmtContext ctx) {
	...
	@Override
	public String visitFor_stmt(ExprParser.For_stmtContext ctx) {
	...
	// test_list: test (',' test)*
	@Override
	public String visitTest_list(ExprParser.Test_listContext ctx) {
	...
	@Override
	public String visitTest(ExprParser.TestContext ctx) {
	...
	@Override
	public String visitOr_test(ExprParser.Or_testContext ctx) {
	...
	@Override
	public String visitAnd_test(ExprParser.And_testContext ctx) {
	...
	@Override
	public String visitNot_test(ExprParser.Not_testContext ctx) {
		String ret = null;
	 ...
	 */
	@Override
	public String visitComp_op(ExprParser.Comp_opContext ctx) {
		String text = ctx.getText();
		String ret = null;
		switch (text) {
		case "<":
	...
	public String visitArith_expr(ExprParser.Arith_exprContext ctx) {
		...
		while (ctx.term(i) != null) {
			arithstring += " " + ctx.ADDMINOP(i - 1).getText() + " "
					+ visit(ctx.term(i++));
			i++;
		}
		/**
		 ...
		 * //println("-----------------generating code-----------------\n");
		 * Writer w = new FileWriter(Envir.exeFileName, false);
		 * w.write(arithstring); w.close(); } catch (IOException e) { // TODO
	...
	// term -> tone
	@Override
	public String visitTTERM(ExprParser.TTERMContext ctx) {
		println("term -> tone");
	...
	public String visitAtom_trailer(ExprParser.Atom_trailerContext ctx) {
		...
		if (ctx.atom() != null) {
			...
			if (atomStr.equals("play")) {
				...
				System.out
						.println("atom_trailer -> (THIS '.')? atom  (trailer)* return:"
								+ ret);
				return ret;
			}
		}
	...
	// atom ->'{' (songmaker)? '}'
	@Override
	public String visitATOMSONG(ExprParser.ATOMSONGContext ctx) {
	...
	// atom -> NAME
	@Override
	public String visitATOMNAME(ExprParser.ATOMNAMEContext ctx) {
		println("atom -> NAME");
		String name = ctx.NAME().getText();
	...
	// atom -> NUMBER
	@Override
	public String visitATOMNUM(ExprParser.ATOMNUMContext ctx) {
		println("atom->number");
	...
	// atom -> STRING+
	@Override
	public String visitATOMSTR(ExprParser.ATOMSTRContext ctx) {
	...
	// atom -> NONE
	@Override
	public String visitATOMNONE(ExprParser.ATOMNONEContext ctx) {
		return ctx.NONE().getText();
	}

	// atom -> TRUE
	@Override
	public String visitATOMTR(ExprParser.ATOMTRContext ctx) {
		return ctx.TRUE().getText();
	}

	// atom -> FALSE
	@Override
	public String visitATOMFAL(ExprParser.ATOMFALContext ctx) {
		return ctx.FALSE().getText();
	}

	// atom -> NOTE
	@Override
	public String visitATOMNOTE(ExprParser.ATOMNOTEContext ctx) {
	...
	// atom -> '(' (listmaker_test)? ')'
	@Override
	public String visitATOMLIST(ExprParser.ATOMLISTContext ctx) {
		println("'(' (listmaker_test)? ')' ");
		String ret = "";
		if (ctx.listmaker_test() != null)
	...
	// atom -> '[' (sequencemaker)? ']'
	@Override
	public String visitATOMSEQ(ExprParser.ATOMSEQContext ctx) {
		println("'[' (sequencemaker)? ']'");
		String ret = "";
		if (ctx.sequencemaker() != null)
			ret = visit(ctx.sequencemaker());
		ret = "[" + ret + "]";
		return ret;
	}
	...
	// trailer ->'(' arglist? ')'
	@Override
	public String visitTLRARG(ExprParser.TLRARGContext ctx) {
	...
	@Override
	public String visitTLRSUBLIST(ExprParser.TLRSUBLISTContext ctx) {
	...
	// trailer -> '.' NAME
	@Override
	public String visitTLRNAME(ExprParser.TLRNAMEContext ctx) {
	...
	@Override
	public String visitSubscriptlist(ExprParser.SubscriptlistContext ctx) {
	...
	// subscript -> test
	@Override
	public String visitSUBSCRT(ExprParser.SUBSCRTContext ctx) {
	...
	@Override
	public String visitSUBSCRTT(ExprParser.SUBSCRTTContext ctx) {
	...
	// sliceop -> ':' (test)?
	@Override
	public String visitSliceop(ExprParser.SliceopContext ctx) {
	...
	@Override
	public String visitListmaker_test(ExprParser.Listmaker_testContext ctx) {
	...
	@Override
	public String visitSequencemaker(ExprParser.SequencemakerContext ctx) {
	...
	@Override
	public String visitParameters(ExprParser.ParametersContext ctx) {
	...
	// varagslist -> (fpdef ('=' test)? ',')* ('*' NAME (',' '**' NAME)? | '**'
	// NAME)
	// | fpdef ('=' test)? (',' fpdef ('=' test)?)* (',')?
	@Override
	public String visitVarargslist(ExprParser.VarargslistContext ctx) {
		// String s=null;
		int i = 0;
		StringBuffer sb = new StringBuffer();
	...
	@Override
	public String visitFPDEFNAME(ExprParser.FPDEFNAMEContext ctx) {
		// println("TOKENN:"+ctx.getText());
		return ctx.getText();
	}

	@Override
	public String visitFPDEFLIST(ExprParser.FPDEFLISTContext ctx) {
	...
	/**
	 * @Override public String visitTerm(ExprParser.TermContext ctx) {
	 * 
	 *           return visitChildren(ctx); }
	 **/
	 ...
	 *           visitSelection_stmt(ExprParser.Selection_stmtContext ctx){
